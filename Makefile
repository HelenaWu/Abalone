...
CFLAGS = -Wall
PROGRAM = main
OBJECTS = ./Computation/verifie_coup.o ./Computation/mise_a_jour.o ./Analyse/trait_cmd.o ./Analyse/lecture_fichier.o ./Affichage/affichage_plateau.o
SOURCES = $(patsubst %.o, %.c,$(OBJECTS))
SUBDIRS = Analyse #les autres apres
